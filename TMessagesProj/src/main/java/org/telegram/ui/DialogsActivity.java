...
import xyz.nextalone.nexagram.MainTabsStyle;
...
import xyz.nextalone.nexagram.helper.DialogsRecentForwardHelper;
        ...
        if (onlySelect) {
            ...
            if (folderId != 0) {
                ...
                if (title.equals(getString(R.string.NekoX))) {
                    logoDrawable = context.getResources().getDrawable(R.drawable.nexagram_logo_2).mutate();
